...
import { Eye, EyeOff, Loader2, Lock, Mail, PawPrint, User } from "lucide-react";
...
const SignUpPage = () => {
  ...
  // getting state from store - zustand.
  ...
  // updating state with got formData
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input type="text" className={`input input-bordered w-full pl-10`} placeholder="Poorana Selvan" value={formData.fullName} onChange={(e) => setFormData({ ...formData, fullName: e.target.value })}/>
              </div>
            </div>
